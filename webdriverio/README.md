...
```javascript
await browser.$('(//p[@class="shelf-item__title"])[3]').click(); // Say change product id to 2
await browser.$('(//div[@class="shelf-item__buy-btn"])[3]').click(); // Say change add to card locator id to 2
```
