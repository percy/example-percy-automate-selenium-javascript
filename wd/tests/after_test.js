...
describe("PercyOnAutomate demo test", () => {
  ...
  test(
    ...
    async () => {
      ...
      await driver.findElement(By.xpath('//*[@id="__next"]/div/div/main/div[1]/div[2]/label/span')).click();
      ...
      await driver.wait(until.elementLocated(By.xpath('//*[@id="10"]/p')));
      let productText = await driver
        .findElement(By.xpath('//*[@id="10"]/p'))
        .getText();
      // clicking the 'Add to cart' button
      await driver.findElement(By.xpath('//*[@id="10"]/div[4]')).click();
